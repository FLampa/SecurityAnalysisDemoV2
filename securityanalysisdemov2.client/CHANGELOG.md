...
- Create Angular project with ng: `ng new securityanalysisdemov2.client --defaults --skip-install --skip-git `.
...
- Create project file (`securityanalysisdemov2.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `securityanalysisdemov2.client.esproj`).
